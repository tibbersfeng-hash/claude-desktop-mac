...
extension Font {
    ...
    public static let windowTitle = Font.system(size: 22, weight: .semibold)
    ...
    public static let bodyText = Font.system(size: 15, weight: .regular)
    ...
    public static let inlineCode = Font.system(size: 14, weight: .regular, design: .monospaced)

    /// Tool output - 12pt, Regular, Monospaced
    public static let toolOutput = Font.system(size: 12, weight: .regular, design: .monospaced)
    ...
    public static let labelText = Font.system(size: 11, weight: .regular)

    // MARK: - Message Typography

    /// User message text
    public static let userMessage = Font.system(size: 15, weight: .regular)

    /// Assistant message text
    public static let assistantMessage = Font.system(size: 15, weight: .regular)

    /// Message metadata
    public static let messageMetadata = Font.system(size: 11, weight: .regular)

    // MARK: - Session List Typography

    /// Session title
    public static let sessionTitle = Font.system(size: 13, weight: .medium)

    /// Session subtitle
    public static let sessionSubtitle = Font.system(size: 11, weight: .regular)

    /// Session timestamp
    public static let sessionTimestamp = Font.system(size: 10, weight: .regular)

    // MARK: - Input Typography

    /// Input field text
    public static let inputText = Font.system(size: 15, weight: .regular)

    /// Placeholder text
    public static let placeholderText = Font.system(size: 15, weight: .regular)

    // MARK: - Status Typography

    /// Status bar text
    public static let statusText = Font.system(size: 12, weight: .regular)

    /// Connection status
    public static let connectionStatus = Font.system(size: 12, weight: .medium)

    // MARK: - Tool Call Typography

    /// Tool name
    public static let toolName = Font.system(size: 13, weight: .medium)

    /// Tool arguments
    public static let toolArguments = Font.system(size: 12, weight: .regular, design: .monospaced)

    /// Tool result
    public static let toolResult = Font.system(size: 12, weight: .regular, design: .monospaced)

    // MARK: - Diff Typography

    /// Diff line number
    public static let diffLineNumber = Font.system(size: 11, weight: .regular, design: .monospaced)

    /// Diff code
    public static let diffCode = Font.system(size: 12, weight: .regular, design: .monospaced)

    /// Diff header
    public static let diffHeader = Font.system(size: 13, weight: .medium)
}
